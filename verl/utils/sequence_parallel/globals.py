...
class ProcessGroupManager(Singleton):
    ...
    def __init__(self, ulysses_degree, ring_degree, sp_gp, ring_type):
        if not hasattr(self, "__initialized"):
            ...
            self.ulysses_pg = sp_gp
            self.ulysses_rank = dist.get_rank(sp_gp)
...
def set_pg_manager(sp_degree, sp_group, sp_ring_degree=1, use_ulysses_low=True, ring_type=None):
    """
    ...
    PROCESS_GROUP_MANAGER = ProcessGroupManager(sp_ulysses_degree, sp_ring_degree, sp_group, ring_type)

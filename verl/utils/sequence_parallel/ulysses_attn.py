...
from .globals import get_ulysses_seq_len, get_ulysses_sp_rank, get_ulysses_sp_size
...
class UlyssesAttention(torch.nn.Module):
    ...
    def forward(
        ...
        *args: Any,
        ...
        # print(f"Ulysses Attention: {get_ulysses_sp_rank()}/{get_ulysses_sp_size()}, q: {q.shape}, k: {k.shape}, v: {v.shape}")
        ...
        context_layer_shape = context_layer.shape if hasattr(context_layer, "shape") else f"non-tensor: {type(context_layer)}"
        # print(
        #     f"Ulysses Attention: {get_ulysses_sp_rank()}/{get_ulysses_sp_size()}, context_layer: {context_layer_shape}"
        # )  # torch.Size([2, 10562, 7, 128])
        ...
        # print(
        #     f"Ulysses Attention: {get_ulysses_sp_rank()}/{get_ulysses_sp_size()}, output: {output.shape}"
        # )  # torch.Size([2, 2640, 28, 128])
